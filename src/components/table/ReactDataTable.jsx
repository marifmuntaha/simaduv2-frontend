...
const LoadingSpinner = () => (
    <div style={{padding: '5px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
        <Spinner /> <span style={{marginTop: '1px'}}>Memuat...</span>
    </div>
)
const ReactDataTable = ({data, columns, pagination, actions, className, selectableRows, expandableRows, progressPending}) => {
