...
import {destroy as destroyUser, store as storeUser} from "../../utils/api/user"
import {calcPercentage} from "../../utils/Utils";
import * as xlxs from "xlsx";
import moment from "moment";
import {store as storeTeacher} from "../../utils/api/teacher.jsx";
                ...
                <form className="is-alter" onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                            ...
                            <span className="ff-italic">Silahkan mengunduh template Data Guru <a href={"#"}>disini</a> </span>
                        </div>
                    </div>
                    <div className="form-group">
                        {loading === true && (
