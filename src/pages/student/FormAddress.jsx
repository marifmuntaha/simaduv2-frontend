...
const FormAddress = ({formData, setFormData, methods, ...props}) => {
    ...
    useEffect(() => {
        fetch(`https://marifmuntaha.github.io/api-wilayah-indonesia/api/regencies/${formData.provinceId}.json`)
            .then(response => response.json())
            .then((regencies) => {
                setCityOptions(() => {
    ...
    useEffect(() => {
        fetch(`https://marifmuntaha.github.io/api-wilayah-indonesia/api/districts/${formData.cityId}.json`)
            .then(response => response.json())
            .then((districts) => {
                setDistrictOptions(() => {
    ...
    useEffect(() => {
        fetch(`https://marifmuntaha.github.io/api-wilayah-indonesia/api/villages/${formData.districtId}.json`)
            .then(response => response.json())
            .then((villages) => {
                setVillageOptions(() => {
